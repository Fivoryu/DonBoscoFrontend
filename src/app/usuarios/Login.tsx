...
export default function Login() {
  ...
  return (
    <div
      className={clsx(
        "min-h-screen flex bg-blue-50",
        sidebarOpen ? "md:pl-64" : "md:pl-16"
      )}
    >
      {/* Sidebar solo para pruebas, puedes quitarlo después */}
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="bg-white flex flex-col md:flex-row w-full max-w-4xl rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="hidden md:flex md:w-1/2 bg-blue-100 items-center justify-center p-8">
              <img
                src="https://img.freepik.com/vector-gratis/ilustracion-concepto-abstracto-pagina-inicio-sesion_335657-2242.jpg?semt=ais_hybrid&w=740"
                alt="Illustration"
